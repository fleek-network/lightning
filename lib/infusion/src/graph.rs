...
pub struct DependencyGraph {
    pub(crate) vtables: IndexMap<Tag, VTable>,
    insertion_order: Vec<Tag>,
    dependency_graph: IndexMap<Tag, IndexSet<Tag>>,
    inputs: IndexSet<Tag>,
}
...
impl DependencyGraph {
    ...
    pub fn new(collection_vtables: Vec<VTable>) -> Self {
        ...
        let allowed = {
            let mut seen = IndexSet::<Tag>::with_capacity(collection_vtables.len());
        ...
        let mut vtables = IndexMap::with_capacity(len);
        let insertion_order = Vec::with_capacity(len);
        let dependency_graph = IndexMap::with_capacity(len);
        let inputs = IndexSet::new();
    ...
    pub fn get_inputs(&self) -> &IndexSet<Tag> {
        &self.inputs
    }

    /// Returns the dependency graph.
    pub fn get_graph(&self) -> &IndexMap<Tag, IndexSet<Tag>> {
    ...
    pub fn sort(&self) -> Result<Vec<Tag>, CycleFound> {
        ...
        let mut in_degree = IndexMap::<Tag, usize>::with_capacity(len);
...
pub struct DependencyGraphVisitor {
    allowed: IndexSet<Tag>,
    current: Option<Tag>,
    insertion_order: Vec<Tag>,
    pub(crate) dependency_graph: IndexMap<Tag, IndexSet<Tag>>,
    pub(crate) inputs: IndexSet<Tag>,
}
