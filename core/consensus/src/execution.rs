...
pub struct Execution<Q: SyncQueryRunnerInterface + QueryRunnerExt> {
...
impl<Q: SyncQueryRunnerInterface + QueryRunnerExt> Execution<Q> {
    pub fn new(
        executor: ExecutionEngineSocket,
        reconfigure_notify: Arc<Notify>,
        new_block_notify: Arc<Notify>,
...
#[async_trait]
impl<Q: SyncQueryRunnerInterface + QueryRunnerExt> ExecutionState for Execution<Q> {
