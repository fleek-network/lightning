...
//     secret_key: &AccountOwnerSecretKey,
//     nonce: u64,
// ) -> UpdateRequest { // Deposit some FLK into account 1 prepare_update_request_account(
//   UpdateMethod::StakeLock { node: *node, locked_for, }, secret_key, nonce, )
// }
...
//     let node_1_usd = 0.1 * (commodity_10 as f64) + 0.2 * (commodity_11 as f64); // 2_000 in
// revenue     let node_2_usd = 0.2 * (commodity_21 as f64); // 1_000 in revenue
