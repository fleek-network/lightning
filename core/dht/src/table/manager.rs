...
impl StdManager {
    ...
    pub fn get_bucket_nodes(&self, bucket_index: usize) -> Option<Vec<NodeInfo>> {
    ...
    pub fn set_bucket_nodes(&mut self, bucket_index: usize, nodes: Vec<NodeInfo>) {
        if bucket_index < self.buckets.len() {
    ...
    pub fn update_node_timestamp(&mut self, node_key: NodePublicKey, timestamp: u64) {
...
mod tests {
    ...
    use crate::table::manager::Table;
    use crate::table::server::*;
